...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    # model_path = "model_data/result_model/best_UltraLightweightUnet large optimized_202410230721.pth.pth"
    ...
    cls_weights = np.array([0,15, 0, 0], np.float32)
    # ------------------------------------------------------------------#
    ...
    model = HybridEfficientSeg(num_classes=num_classes).train()
    if not pretrained:
        weights_init(model)
    if model_path != '':
        # ------------------------------------------------------#
    ...
    #   读取数据集对应的txt
    # ---------------------------#
    with open(os.path.join(VOCdevkit_path, "VOC2012/ImageSets/Segmentation/trainval.txt"), "r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "VOC2012/ImageSets/Segmentation/test.txt"), "r") as f:
